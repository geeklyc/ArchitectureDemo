...
#import "JZYIPageSearchBar.h"

@interface JZYIPageWrongVC ()
<JZYIHomeSearchBarProtocol>

@property (nonatomic, readwrite, strong) JZYIPageSearchBar *searchBar ; //!< 搜索bar

@end

@implementation JZYIPageWrongVC
...
- (JZYIPageSearchBar *)searchBar {
    
    if (!_searchBar) {
        
        _searchBar = [[JZYIPageSearchBar alloc] initWithFrame:CGRectMake(0, 100, 320, 80)];
